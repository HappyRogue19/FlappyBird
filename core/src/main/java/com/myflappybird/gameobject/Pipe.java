...
public class Pipe extends Scrollable{
    ...
    public void resize(int width, int height) {
        this.width = width / 12;
        this.height = height / 6; // Пример: высота трубки 1/6 от высоты экрана
        // Пропорциональное изменение зазора между трубами
        VERTICAL_GAP = height / 5;
        // Пропорциональное изменение ширины и высоты черепа
        SKULL_WIDTH = width / 12; // Пример: череп — 1/12 от ширины экрана
